...
plot3(handles.axes_robot,x_range,y_range,z_range,':c')
% (handles.axes_robot,x_range,y_range,z_range,'LineStyle','none','Color','b','Marker','square','MarkerSize',2)
...
plot3(handles.axes_robot,x_range(mark:end),y_range(mark:end),z_range(mark:end),'.c','MarkerSize',2)
